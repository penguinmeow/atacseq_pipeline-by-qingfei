...
def create_job_file_pe(samplefile1, samplefile2, adapters, out_dir, trim_reads):
    ...
    module1 += 'export PATH="~/.local/bin:$PATH" \n'
    ...
    job_body4 = 'java -jar /hpcf/apps/picard/install/2.9.4/picard.jar AddOrReplaceReadGroups I= {}tmp.aligned.bam O= {}tmp.RGadded.bam SO=coordinate RGID={} RGLB={} RGPL=ATAC RGPU=Illumina RGSM={}\n'
    job_body4 += 'java -jar /hpcf/apps/picard/install/2.9.4/picard.jar MarkDuplicates I= {}tmp.RGadded.bam O= {}02_alignment.raw.bam M= {}tmp.dupMark.txt'
    ...
    job_body7 = job_body7.format(prefix+'/', prefix)
