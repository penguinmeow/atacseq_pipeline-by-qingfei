...
def create_job_file_pe(samplefile1, samplefile2, out_dir):
    ...
    job_body8 += 'perl perl /research/rgs01/project_space/yu3grp/software_JY/yu3grp/git_repo/ATACseq_pipeline/scripts/annotationToNetwork.pl {}/04_footPrint_mpbs.annotate.txt {}/04_networkATACseq.txt\n'
